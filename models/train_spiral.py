...
def main():
    ...
    BASE_PATH = r"C:\Users\DELL\OneDrive\Documents\Parkinson-Disease-Early-Detection\Data\raw\drawings\spiral"
    ...
    print("Total Spiral Images:", len(X))
    ...
    model.save("models/saved_models/cnn_spiral.keras")

    print("Spiral training complete.")
